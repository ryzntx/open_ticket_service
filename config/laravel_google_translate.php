...
return [
    ...
    'custom_api_translator' => env('CUSTOM_API_TRANSLATOR', \Hlacos\DeeplApiTranslator\DeeplFreeApiTranslator::class),
    'custom_api_translator_key' => env('CUSTOM_API_TRANSLATOR_KEY', 'a012988a-93a2-4d55-a664-2a98e0b787bb:fx'),
    'api_limit_settings' => [
