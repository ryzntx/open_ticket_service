...
<body>
    ...
    <div class="card">
        ...
        <p>Tiket bantuan Anda dengan kode <strong>{{ $ticket->code }}</strong> telah <strong>dibalas</strong> oleh tim
            support kami.</p>
        ...
        <ul style="padding-left: 20px; margin: 0;">
            ...
            <li><strong>Tanggal Dibalas:</strong> {{ now()->format('d M Y H:i') }}</li>
        </ul>
        ...
        <div style="margin-top: 24px;">
            <a href="{{ url('/ticket/check/' . $ticket->code) }}" class="btn">Lihat Balasan</a>
        </div>
